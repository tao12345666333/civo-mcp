...
describe('Tool Definitions', () => {
  describe('Instance Tools', () => {
    it('should have correct CREATE_INSTANCE_TOOL definition', () => {
      ...
      expect(CREATE_INSTANCE_TOOL.description).toBe(
        'Create a new cloud instance on Civo'
      );
      expect(CREATE_INSTANCE_TOOL.inputSchema.type).toBe('object');
      expect(CREATE_INSTANCE_TOOL.inputSchema.properties).toHaveProperty(
        'hostname'
      );
      expect(CREATE_INSTANCE_TOOL.inputSchema.properties).toHaveProperty(
        'size'
      ...
      expect(CREATE_INSTANCE_TOOL.inputSchema.required).toEqual([
        'hostname',
        'size',
        'template_id',
      ]);
    ...
    it('should have correct LIST_INSTANCES_TOOL definition', () => {
      ...
      expect(LIST_INSTANCES_TOOL.description).toBe(
        'List all instances on Civo'
      );
      expect(LIST_INSTANCES_TOOL.inputSchema.type).toBe('object');
      expect(LIST_INSTANCES_TOOL.inputSchema.properties).toHaveProperty(
        'region'
      );
    ...
    it('should have correct REBOOT_INSTANCE_TOOL definition', () => {
      ...
      expect(REBOOT_INSTANCE_TOOL.description).toBe(
        'Reboot a cloud instance on Civo'
      );
      expect(REBOOT_INSTANCE_TOOL.inputSchema.required).toEqual([
        'id',
        'region',
      ]);
    });
    ...
    it('should have correct SHUTDOWN_INSTANCE_TOOL definition', () => {
      ...
      expect(SHUTDOWN_INSTANCE_TOOL.description).toBe(
        'Shutdown a cloud instance on Civo'
      );
      expect(SHUTDOWN_INSTANCE_TOOL.inputSchema.required).toEqual([
        'id',
        'region',
      ]);
    });
    ...
    it('should have correct START_INSTANCE_TOOL definition', () => {
      ...
      expect(START_INSTANCE_TOOL.description).toBe(
        'Start a cloud instance on Civo'
      );
      expect(START_INSTANCE_TOOL.inputSchema.required).toEqual([
        'id',
        'region',
      ]);
    });
    ...
    it('should have correct RESIZE_INSTANCE_TOOL definition', () => {
      ...
      expect(RESIZE_INSTANCE_TOOL.description).toBe(
        'Resize a cloud instance on Civo'
      );
      expect(RESIZE_INSTANCE_TOOL.inputSchema.required).toEqual([
        'id',
        'size',
        'region',
      ]);
    ...
    it('should have correct DELETE_INSTANCE_TOOL definition', () => {
      ...
      expect(DELETE_INSTANCE_TOOL.description).toBe(
        'Delete a cloud instance on Civo'
      );
      expect(DELETE_INSTANCE_TOOL.inputSchema.required).toEqual([
        'id',
        'region',
      ]);
    });
  ...
  describe('Disk Image Tools', () => {
    it('should have correct LIST_DISK_IMAGES_TOOL definition', () => {
      ...
      expect(LIST_DISK_IMAGES_TOOL.description).toBe(
    ...
    it('should have correct GET_DISK_IMAGE_TOOL definition', () => {
      ...
      expect(GET_DISK_IMAGE_TOOL.description).toBe(
  ...
  describe('Size Tools', () => {
    it('should have correct LIST_SIZES_TOOL definition', () => {
      ...
      expect(LIST_SIZES_TOOL.description).toBe(
  ...
  describe('Region Tools', () => {
    it('should have correct LIST_REGIONS_TOOL definition', () => {
      ...
      expect(LIST_REGIONS_TOOL.description).toBe(
  ...
  describe('Network Tools', () => {
    it('should have correct LIST_NETWORKS_TOOL definition', () => {
      ...
      expect(LIST_NETWORKS_TOOL.description).toBe(
    ...
    it('should have correct CREATE_NETWORK_TOOL definition', () => {
      ...
      expect(CREATE_NETWORK_TOOL.description).toBe(
  ...
  describe('Kubernetes Tools', () => {
    it('should have correct LIST_KUBERNETES_CLUSTERS_TOOL definition', () => {
      expect(LIST_KUBERNETES_CLUSTERS_TOOL.name).toBe(
        'list_kubernetes_clusters'
      );
      expect(LIST_KUBERNETES_CLUSTERS_TOOL.description).toBe(
    ...
    it('should have correct CREATE_KUBERNETES_CLUSTER_TOOL definition', () => {
      expect(CREATE_KUBERNETES_CLUSTER_TOOL.name).toBe(
        'create_kubernetes_cluster'
      );
      expect(CREATE_KUBERNETES_CLUSTER_TOOL.description).toBe(
        'Create a new Kubernetes cluster on Civo'
      );
      expect(CREATE_KUBERNETES_CLUSTER_TOOL.inputSchema.required).toEqual([
        'name',
        'region',
        'network_id',
        'nodes',
    ...
    it('should have correct DELETE_KUBERNETES_CLUSTER_TOOL definition', () => {
      expect(DELETE_KUBERNETES_CLUSTER_TOOL.name).toBe(
        'delete_kubernetes_cluster'
      );
      expect(DELETE_KUBERNETES_CLUSTER_TOOL.description).toBe(
        'Delete a Kubernetes cluster on Civo'
      );
      expect(DELETE_KUBERNETES_CLUSTER_TOOL.inputSchema.required).toEqual([
        'id',
        'region',
      ]);
    });
    ...
    it('should have correct LIST_KUBERNETES_VERSIONS_TOOL definition', () => {
      expect(LIST_KUBERNETES_VERSIONS_TOOL.name).toBe(
        'list_kubernetes_versions'
      );
      expect(LIST_KUBERNETES_VERSIONS_TOOL.description).toBe(
