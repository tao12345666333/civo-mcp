import { CREATE_INSTANCE_TOOL, LIST_INSTANCES_TOOL, REBOOT_INSTANCE_TOOL, SHUTDOWN_INSTANCE_TOOL, START_INSTANCE_TOOL, RESIZE_INSTANCE_TOOL, DELETE_INSTANCE_TOOL } from './instances';
import { GET_DISK_IMAGE_TOOL, LIST_DISK_IMAGES_TOOL } from './disk-images';
import { LIST_SIZES_TOOL } from './sizes';
import { LIST_REGIONS_TOOL } from './regions';
import { LIST_NETWORKS_TOOL, CREATE_NETWORK_TOOL, RENAME_NETWORK_TOOL, DELETE_NETWORK_TOOL } from './networks';
import { LIST_KUBERNETES_CLUSTERS_TOOL, CREATE_KUBERNETES_CLUSTER_TOOL, DELETE_KUBERNETES_CLUSTER_TOOL, LIST_KUBERNETES_VERSIONS_TOOL } from './kubernetes';
